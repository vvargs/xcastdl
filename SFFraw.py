...
download_command = 'streamlink --hls-live-restart --retry-open 3 --retry-streams 30 --retry-max 300 --stream-segment-threads 8 --force-progress -o "DL/%s.ts" "%s" best' % (output, m3u8_url)
